...
[source,javascript]
----
include::{sourcedir}/deepdive/functional/ValidatorWithFunctionalCombination.js[tags=validation-combination]
----
...
[source,javascript]
----
include::{sourcedir}/deepdive/functional/ValidatorWithFunctionalCombination.js[tags=validation-usage]
----

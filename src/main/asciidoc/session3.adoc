...
So kann der Typ `Bool` lediglich zwei Werte annehmen: `true` und `false`. Der Typ `Int` kann dagegen die Werte
`-2147483648` bis `2147483647` annehmen. `String`
...
[source,javascript]
----
include::{sourcedir}/../kotlin/functionalDDD/Types.kt[tags=kotlin_init_validation]
----

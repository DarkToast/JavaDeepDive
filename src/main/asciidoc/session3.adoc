...
[source,javascript]
----
include::{sourcedir}/deepdive/functional/js/FirstClassCitizens.js[tags=classic]
----
...
[source,javascript]
----
include::{sourcedir}/deepdive/functional/js/FirstClassCitizens.js[tags=f_as_val]
----
...
[source,javascript]
----
include::{sourcedir}/deepdive/functional/js/FirstClassCitizens.js[tags=f_as_param]
----
...
[source,javascript]
----
include::{sourcedir}/deepdive/functional/js/HigherOrderFunction.js[tags=function_builder]
----

[source,javascript]
----
include::{sourcedir}/deepdive/functional/js/HigherOrderFunction.js[tags=function_parameter]
----

[source,javascript]
----
include::{sourcedir}/deepdive/functional/js/HigherOrderFunction.js[tags=lib_example]
----

...
Transient ist ein Marker für Variablen, welche bei einer Serialisierung ignoriert werden sollen. Aus der Zeit vor Json
und Jackson und `@JsonIgnore` Annotations konnte man bereits dort Objekte partiell serialisieren.

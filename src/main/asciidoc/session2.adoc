...
Typbezeichner. Wie im unteren Beispiel gezeit, bauen wir uns einen `ElementAdder`, der einen Typparameter vom Namen
`E` mitbringt, der den Typ unserer Elemente darstellen soll.

Diesen Typparameter können wir nun, wie jeden anderen Typ für Parameter, Rückgabewerte oder auch wieder als

...
Final im Kontext eines Klassenattributs. Diese können dabei und im Klassenkontext oder im Konstuktor initialisiert
werden, da dieser bei der Objecterzeugung aufgerufen wird. Andere Methoden sind tabu.
